...
const get_curriculum_dto_1 = require("./get-curriculum.dto");
let CurriculumController = class CurriculumController {
    constructor(curriculumService) {
        this.curriculumService = curriculumService;
    }
    getCombinedCurriculum(getCurriculumDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [get_curriculum_dto_1.GetCurriculumDto]),
    __metadata("design:returntype", void 0)
], CurriculumController.prototype, "getCombinedCurriculum", null);
